    ...
    <footer className="mt-32 border-t border-brand-line bg-brand-primary text-white">
      <div className="container-page grid gap-12 py-16 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm">
            <li>
              <Link href="/totaalrenovatie" className="text-white/85 hover:text-white">
                Totaalrenovatie
              </Link>
            </li>
            <li>
              <Link href="/realisaties" className="text-white/85 hover:text-white">
                Realisaties
              </Link>
            </li>
            <li>
              <Link href="/over-ons" className="text-white/85 hover:text-white">
                Over ons
              </Link>
            </li>
            <li>
              <Link href="/voor-aannemers" className="text-white/85 hover:text-white">
                Voor aannemers
              </Link>
            </li>
            <li>
